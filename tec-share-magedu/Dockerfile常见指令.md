...
提问：容器技术已经是老生常谈的技术了。当面试官问你，容器技术的核心技术是什么？你如何回答。

三大技术核心：**命名空间、控制组和文件系统**。分别对应namespace， cgroups， unionFS
...
docker image inspect <image> --format "{{json .ContainerConfig.Labels}}"|jq
```
